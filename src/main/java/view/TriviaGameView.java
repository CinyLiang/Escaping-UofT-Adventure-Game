...
public class TriviaGameView extends JPanel implements PropertyChangeListener {
    ...
    private final JPanel questionContentPanel;
    ...
    public TriviaGameView(TriviaGameViewModel viewModel) {
        ...
        questionContentPanel = new JPanel(new GridBagLayout());
        questionContentPanel.add(questionLabel);

        questionScrollPane = new JScrollPane(questionContentPanel);
    ...
    private void applyTheme() {
        ...
        questionContentPanel.setBackground(view.ThemeManager.getBackground());
